...
df$Global_reactive_power <- as.numeric(as.character(df$Global_reactive_power)) #convert factors to numeric
df$Voltage <- as.numeric(as.character(df$Voltage)) #convert factors to numeric
